...
/** function that draws circles and fills them in a certain color.
 * @param {number} x1 Moves the starting circle allong the horizontal axis.
 * @param {number} y1 Moves the starting circle allong the vertical axis.
 * @param {number} radius Decides the size of the circle in question.
 */
export function fillAndStrokeCircle2(x1, y1, radius) {
	context.beginPath();
 ...
 */
export function fillAndStrokeEllipse(x1, y1, rX, rY) {
	context.beginPath();
